...
class GameGenreScreen extends ConsumerStatefulWidget {
  const GameGenreScreen({super.key, this.id});

  final String? id;

  @override
  ConsumerState<GameGenreScreen> createState() => _GameGenreScreenState();
}

class _GameGenreScreenState extends ConsumerState<GameGenreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final genresAsyncValue = ref.watch(gameGenresProvider(widget.id!));
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          'JUEGOS DE ${data?[0].genre.toUpperCase() ?? 'Desconocido'}',
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      final gameEntity = GameEntity(
                        id: genres.gameId,
                        title: genres.title,
                        coverImageUrl: genres.coverImage,
