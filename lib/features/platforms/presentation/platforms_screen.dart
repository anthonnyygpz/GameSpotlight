...
import 'package:gamespotlight/features/platforms/presentation/widget/platform_card.dart';
...
class _PlatformsScreenState extends ConsumerState<PlatformsScreen> {
  ...
  Widget build(BuildContext context) {
    final platformAsyncValue = ref.watch(platformsProvider);
        ...
        builder: (data) {
          ...
          return SidebarNavigationHandler(
            ...
            onContentSelect: (row, col) {
              ...
              context.push(AppRoutes.gamePlatformsPath(selected.id));
            },
            onMoveUpOverride: (currentRow, currentCol, counts) {
              if (currentRow > 0) {
                final isLastInCurrentRow = currentCol == counts[currentRow] - 1;

                if (isLastInCurrentRow) {
                  final targetRow = currentRow - 1;
                  final targetCol = counts[targetRow] - 1;

                  controller.jumpTo(targetRow, targetCol);
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      final gameEntity = PlatformEntity(
                        id: platforms.id,
                        name: platforms.name,
                        type: platforms.type,
